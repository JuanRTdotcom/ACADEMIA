<script lang="ts" module>
	// Stroke icon set (lucide-style, 24x24, currentColor). Add names here as needed.
	export const icons: Record<string, string> = {
		...
		stethoscope: '<path d="M11 2v2"/><path d="M5 2v2"/><path d="M5 3H4a2 2 0 0 0-2 2v3a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1"/><path d="M8 14a6 6 0 0 0 12 0v-3"/><circle cx="20" cy="10" r="2"/>',
		...
		hospital: '<path d="M12 6v4"/><path d="M14 8h-4"/><path d="M14 14h.01"/><path d="M14 18h.01"/><path d="M10 14h.01"/><path d="M10 18h.01"/><path d="M18 12h2a2 2 0 0 1 2 2v8H2V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16"/>',
		'flask-conical': '<path d="M10 2v7.31"/><path d="M14 9.3V1.99"/><path d="M8.5 2h7"/><path d="M14 9.3 19.6 18a2 2 0 0 1-1.7 3H6.1a2 2 0 0 1-1.7-3L10 9.3"/><path d="M6.5 15h11"/>',
		scissors: '<circle cx="6" cy="7" r="3"/><path d="M8.7 8.4 21 15"/><circle cx="6" cy="17" r="3"/><path d="M8.7 15.6 21 9"/>',
		'paw-print': '<circle cx="11" cy="4" r="2"/><circle cx="18" cy="8" r="2"/><circle cx="20" cy="16" r="2"/><path d="M9 10a5 5 0 0 1 5 5v3.5a3.5 3.5 0 0 1-6.84 1.04A4 4 0 0 0 4.5 17H4a2 2 0 0 1 0-4h.5A4 4 0 0 0 9 10Z"/>',
		...
		images: '<path d="M18 22H4a2 2 0 0 1-2-2V6"/><path d="m22 15-5-5L5 22"/><path d="m6 18-2-2"/><rect width="16" height="16" x="6" y="2" rx="2"/>',
		'calendar-clock': '<path d="M16 14v2.2l1.6 1"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M8 2v4"/><path d="M21 13V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8"/><circle cx="16" cy="16" r="6"/>',
		...
		'music-2': '<circle cx="8" cy="18" r="3"/><path d="M11 18V2l10 3v13"/><circle cx="18" cy="18" r="3"/>',
		youtube: '<path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.94 2C5.12 20 12 20 12 20s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><path d="m10 15 5-3-5-3z"/>',
		linkedin: '<path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/>',
		'at-sign': '<circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8"/>',
		signpost: '<path d="M12 3v18"/><path d="M18 6H6l-3 3 3 3h12l3-3z"/>',
		'life-buoy': '<circle cx="12" cy="12" r="10"/><path d="m4.93 4.93 4.24 4.24"/><path d="m14.83 14.83 4.24 4.24"/><path d="m14.83 9.17 4.24-4.24"/><path d="m14.83 9.17-5.66 5.66"/><circle cx="12" cy="12" r="4"/><path d="m9.17 9.17-4.24-4.24"/><path d="m9.17 14.83-4.24 4.24"/>',
		...
		megaphone:
			'<path d="m3 11 18-5v12L3 14v-3Z"/><path d="M11.6 16.1 13 21H8l-1.2-6"/><path d="M3 11v3"/>',
		'badge-check':
			'<path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"/><path d="m9 12 2 2 4-4"/>',
		shield:
			'<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/>',
		'monitor-smartphone':
			'<path d="M18 8V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h6"/><path d="M2 12h8"/><rect width="8" height="12" x="14" y="10" rx="2"/><path d="M18 18h.01"/>',
		flag:
		...
		files:
			'<path d="M15 2H6a2 2 0 0 0-2 2v12"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M18 22H9a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h5l6 6v9a2 2 0 0 1-2 2"/>',
		'book-open-check':
			'<path d="M12 21V7"/><path d="m16 12 2 2 4-4"/><path d="M3 18a1 1 0 0 1-1-1V5a2 2 0 0 1 2-2h5a3 3 0 0 1 3 3v15a3 3 0 0 0-3-3z"/><path d="M12 6a3 3 0 0 1 3-3h5a2 2 0 0 1 2 2v3"/>',
		'book-open':
		...
		'users-round':
			'<path d="M18 21a8 8 0 0 0-16 0"/><circle cx="10" cy="8" r="5"/><path d="M22 20c0-3.37-2-5.5-4-6.5"/><path d="M16 3.13a5 5 0 0 1 0 9.74"/>',
		'shield-plus':
		...
		'mail-plus':
			'<path d="M16 19h6"/><path d="M19 16v6"/><path d="M22 10.5V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h9"/><path d="m22 7-10 6L2 7"/>',
		lock: '<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',
		'lock-keyhole': '<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/><path d="M12 15v3"/>',
		eye: '<path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/>',
		'eye-off':
			'<path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 10 8 10 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><path d="M1 1l22 22"/><path d="M6.61 6.61A18.5 18.5 0 0 0 2 12s3 7 10 7a9.12 9.12 0 0 0 5.39-1.61"/>',
		...
		sparkles:
			'<path d="M12 3l1.9 4.6L18.5 9.5 13.9 11.4 12 16l-1.9-4.6L5.5 9.5l4.6-1.9z"/><path d="M19 15l.8 2 2 .8-2 .8-.8 2-.8-2-2-.8 2-.8z"/>',
		...
		'trash-2':
			'<path d="M3 6h18"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><path d="M19 6l-1 14c-.1 1.1-1 2-2.1 2H8.1C7 22 6.1 21.1 6 20L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',
		'help-circle':
		...
		signature:
			'<path d="m21 17-2.3.4a2 2 0 0 1-2.1-.9L16 15.6a2 2 0 0 0-2.6-.6L9 17.8"/><path d="M4 16.5V19h2.5L18.4 7.1a2.1 2.1 0 0 0-3-3L3.5 16Z"/>',
		'id-card':
		...
		'venus-and-mars':
			'<path d="M10 20h4"/><path d="M12 16v6"/><path d="M17 2h5v5"/><path d="m21 3-6.4 6.4"/><circle cx="9" cy="11" r="5"/>',
		image:
		...
		package:
			'<path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 3A2 2 0 0 0 3 7v10a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 17Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/>'
	};
</script>
...
<script lang="ts">
	...
	let { name, size = 20, strokeWidth = 1.75, class: klass = '' }: Props = $props();
</script>
